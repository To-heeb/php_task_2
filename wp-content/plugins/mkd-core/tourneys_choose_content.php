...
<div class="container-fluid choose-container bg-light">
  <div class="choose-box px-2 py-4">
    ...
    <div class="content-box flex-css">
      ...
      <div class="main-box content-one flex-css-column mr-3" id="content-one">
      ...
      <!-- two  -->
      <div class="main-box content-two mobile-view flex-css-column ml-3" id="content-two">
  ...
  <div class="choose-alert-wrapper hidden flex-css" id="choose-alert-wrapper">
    <div class="alert-modal px-4 py-3">
      <a href="javascript:void(0)" class="alert-close-icon" id="alert-close-icon">
