...
<style>
  ...
  .tourneys-main-container .tours-list-container .tour-list-box .list-box .ticket-cut {
    height: 40px;
    width: 40px;
    background-color: #ffffff;
    position: absolute;
  ...
  .tourneys-main-container .tours-list-container .tour-list-box .tour-category.hidden {
    display: none;
  }
  ...
  .tourneys-main-container .tours-list-container .tour-list-box .list-box .left-box .image-container-tour img {
    height: 100%;
    width: 100%;
    object-fit: cover;
  ...
  .tourneys-main-container .tours-list-container .tour-list-box .list-box .left-box .btn-container {
    position: absolute;
    top: 0;
    left: 0;
    height: 100%;
  ...
  .tourneys-main-container .tours-list-container .tour-list-box .list-box .left-box .btn-container .enter-btn {
    padding: 2px 25px;
  ...
  .tourneys-main-container .tours-list-container .tour-list-box .list-box .right-box {
    width: 100%;
  }

  .tourneys-main-container .tours-list-container .tour-list-box .list-box .right-box .heading p {
    color: #e10217;
    font-size: 12px;
    font-family: "Oswald", sans-serif;
  ...
  .tourneys-main-container .tours-list-container .tour-list-box .list-box .right-box .heading p:after {
    content: "";
    position: absolute;
    height: 1px;
    width: 70px;
  ...
  .tourneys-main-container .tours-list-container .tour-list-box .list-box .right-box .heading h1 span i {
    font-size: 18px;
  }

  .tourneys-main-container .tours-list-container .tour-list-box .list-box .right-box .info h1 {
    color: #f1f1f1;
    font-size: 14px;
    font-family: "Oswald", sans-serif;
  }

  .tourneys-main-container .tours-list-container .tour-list-box .list-box .right-box .info p {
    color: #f1f1f1;
    font-size: 12px;
    font-family: "Oswald", sans-serif;
    margin: 0;
  ...
  .tourneys-main-container .tours-list-container .tour-list-box .list-box .right-box .info .reg-closes-text {
    text-align: center;
    box-shadow: 0 0 20px #e10217ad;
    padding: 5px !important;
  }

  .tourneys-main-container .tours-list-container .tour-list-box .list-box .right-box .note p {
    display: none;
    color: #f1f1f1;
    font-size: 12px;
    font-family: "Oswald", sans-serif;
  ...
  .modal-form-container .form-container .inputs-container .btn-list-container button {
    border-radius: 3px;
    padding: 7px 25px;
    border-color: transparent;
    font-size: 14px;
...
<div class="container-fluid tourneys-main-container bg-light px-3 py-5">
  <div class="tour-tabs-box flex-css-row-start">
    <a href="javascript:void(0)" class="tour-tab active" id="schedule-tab">Scheduled Tournament</a>
...
<div class="tour-modal-wrapper hidden flex-css" id="tour-modal-wrapper">
  ...
  <div class="tour-modal bg-light p-4">
    <a href="javascript:void(0)" class="tour-close-icon" id="tour-close-icon">
        ...
        <form class="form-container" enctype="multipart/form-data" name="portfolioForm" id="portfolio-form">
          ...
          <div class="inputs-container px-3">
            ...
            <div class="row">
              <div class="col-lg-7">
                <div class="form-group my-2">
                  <label for="exampleFormControlSelect1">Premade Background</label>
                  <br />
                  <button class="bg-info choose-btn" id="choose-btn">
                    Choose
                  </button>
                  <button class="bg-danger choose-btn" id="remove-background">
                    Remove
                  </button>
                  <div class="background-preview">
                    ...
                    <div class="color-container form-preview-container" style="display: none"></div>
                  </div>
    ...
    <div class="color-modal p-4">
      ...
      <div class="inner-modal p-3">
        <div class="tab-container" id="color-tab-content">
          ...
          <ul id="palette" class="flex-css-row-start-wrap m-0 my-4"></ul>
